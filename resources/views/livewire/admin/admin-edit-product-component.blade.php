                            ...
                            <div class="card-body">
                                ...
                                <form wire:submit.prevent="updateProduct">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" name="regular_price" class="form-control" placeholder="Enter products regular price" wire:model="regular_price">
                                        @error('regular_price')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" name="sale_price" class="form-control" placeholder="Enter products sale price" wire:model="sale_price">
                                        @error('sale_price')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" name="quantity" class="form-control" placeholder="Enter products quantity" wire:model="quantity">
                                        @error('quantity')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
